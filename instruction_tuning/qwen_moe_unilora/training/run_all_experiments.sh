#!/bin/bash
# Master script to run all 3 experiments with TCMQA testing
...
echo "=============================================="
echo "Starting All 3 Experiments with TCMQA Testing"
echo "=============================================="
...
# ==========================================
# Experiment 1: Joint Training Only
# ==========================================
echo ""
echo ">>> [EXPERIMENT 1] Joint Training Only..."
cd ${TRAINING_DIR}
bash run_exp1_joint.sh

# Test Experiment 1
test_model "exp1_joint_only" "${TRAINING_DIR}/output/exp1_joint_only"
...
echo "  1. exp1_joint_only"
echo "  2. exp2_attn_only"
echo "  3. exp3_full_combined"
